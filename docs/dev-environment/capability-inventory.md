...
| `nvim-editor` | Neovim | P1 | Maintainer imagem | tarball oficial GitHub (`nvim-linux-x86_64.tar.gz`, pin `ARG NEOVIM_VERSION` no `docker/Dockerfile`) | 0.12.1 | [Neovim stable](https://github.com/neovim/neovim/releases) | ok | Alinhado a [neovim.io/doc/install](https://neovim.io/doc/install/); binário em `/opt/nvim-linux-x86_64/bin/nvim` |
